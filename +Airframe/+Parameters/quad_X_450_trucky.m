...
function Const = quad_X_450_trucky
...
Const.m             = 1.60113;                      %quad mass in kg = frame + batt.
...
Const.MX2T              = 1/(160 *1.0e-3);                  % 1/roll moment arm (1/m)
Const.MY2T              = 1/(160 *1.0e-3);                  % 1/pitch moment arm (1/m)

Const.RADPS2T           = 1.551766452392375e-05;        %[N-s^2/rad^2] thrust = b*(rad/s)^2 thrust curve constant 
Const.RADPS2M           = 2.751314857948442e-07;        %[N-m-s^2/rad^2] torque = d*(rad/s)^2 moment curve constant
Const.MZ2T              = Const.RADPS2T / Const.RADPS2M;%                  

Const.RPM_max       = 7645.0;                       %max RPM
Const.RadPS_max     = Const.RPM_max*pi/30;          %max Rad/s
% Const.Tm            = 0.245217;                     %electric motor time constant
Const.motor_time_constant_s = 1/130; %electric motor time constant
